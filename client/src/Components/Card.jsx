...
const Card = ({ data, deleteStatus = 0 }) => {
    ...
    const renderElement = (customer, index) => {
        let renderedElement;
        if(!editClick) {
            renderedElement = <div className="flex flex-col bg-transparent shadow-[24px_12px_48px_rgba(1.5,0,0,0.7)]  text-start lg:p-3 p-1 gap-y-1 transition-all duration-300 hover:scale-105 rounded-3xl">
